...
rnn=RHT_GCN(num_class=21, num_point=16, num_person=1, in_channels=3,
...
def test(ep):
    ...
    if ep == 1:
        torch.save(rnn.state_dict(), 'RHT-GCN.mdl')
    with torch.no_grad():
