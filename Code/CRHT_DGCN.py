...
class CRHT_DGC(nn.Module):
    def __init__(self, in_channels, out_channels, A, adaptive=True, residual=True, CoM=8):
        ...
        for i in range(self.num_layers): # num_layers 4
            ...
            # 向当前层的conv_d列表中添加一个自定义的EdgeConv层，该层采用5x5卷积核。
...
class STGC_Block(nn.Module):
    def __init__(self, in_channels, out_channels, A, stride=1, residual=True, adaptive=True,
        ...
        self.gcn1 = CRHT_DGC(in_channels, out_channels, A, adaptive=adaptive, CoM=CoM)
